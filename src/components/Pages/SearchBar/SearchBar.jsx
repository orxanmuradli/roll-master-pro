  ...
  return (
    <div className={`search ${className}`}>
      ...
      <div className="searchinputs">
        <input type="text" placeholder={placoholder} value={wordeEntered} onChange={handleFilter} />
